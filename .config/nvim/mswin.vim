...
" mapping
inoremap <C-L> <C-O>:call GotoLine()<CR>
...
" mapping
inoremap <silent> <C-Q> <C-O>:call ExitVim()<CR>
snoremap <silent> <C-Q> <C-O>:call ExitVim()<CR>
nnoremap <silent> <C-Q> :call ExitVim()<CR>
